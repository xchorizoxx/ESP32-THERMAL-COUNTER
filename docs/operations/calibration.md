...
### Closing
Once you observe smooth crossings in the Dashboard under "Raw Peaks" (and their corresponding yellow vector arrows), click **[ SAVE TO FLASH ]** to ensure the values are no longer volatile and persist through power outages (NVS Save).
