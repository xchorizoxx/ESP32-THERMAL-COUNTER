...
constexpr float FLOOR_TEMP_MIN_C     = 10.0f;   // Temp. mínima esperada del suelo [°C]
constexpr float FLOOR_TEMP_MAX_C     = 23.0f;   // Temp. máxima esperada del suelo [°C]
...
constexpr int   IPC_QUEUE_DEPTH      = 5;       // Profundidad de la queue FreeRTOS
